...
def init_args():
    ...
    # parser.add_argument('--mode', type=str, default="eval", help='train/test')
...
if __name__ == "__main__":
    ...
    if args.model == "wsdan":
        ...
        model.fc = nn.Sequential(nn.Dropout(0.2), nn.Linear(2048, 3))
    ...
    if args.mode == "eval":
        ...
        eval_loader = torch.utils.data.DataLoader(eval_dataset, batch_size=args.batch_size,
                                                  num_workers=args.num_workers, shuffle=True, drop_last=True)
        evl(model, train_loader, eval_loader, args)
